...
class scale_block(nn.Module):
    ...
    def __init__(self, win_size, d_model, n_heads, d_ff, num_nodes, depth, dropout, seg_num=10, factor=10):
...
class Encoder(nn.Module):
    ...
    def __init__(self, e_blocks, win_size, d_model, n_heads, d_ff, num_nodes, block_depth, dropout,
                 in_seg_num=10, factor=10):
        super(Encoder, self).__init__()
        self.encode_blocks = nn.ModuleList()

        self.encode_blocks.append(scale_block(1, d_model, n_heads, d_ff, num_nodes, block_depth, dropout,
                                              in_seg_num, factor))
        for i in range(1, e_blocks):
            self.encode_blocks.append(scale_block(win_size, d_model, n_heads, d_ff, num_nodes, block_depth, dropout,
