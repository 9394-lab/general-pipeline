...
class DecoderLayer(nn.Module):
    ...
    def __init__(self, seg_len, d_model, n_heads, d_ff, num_nodes, dropout=0.1, out_seg_num=10, factor=10):
...
class Decoder(nn.Module):
    ...
    def __init__(self, seg_len, d_layers, d_model, n_heads, d_ff, num_nodes, dropout,
        ...
        for i in range(d_layers):
            self.decode_layers.append(DecoderLayer(seg_len, d_model, n_heads, d_ff, num_nodes,
                                                   dropout, out_seg_num, factor))
