...
class ASTGNN(nn.Module):
    def __init__(self, num_layers, encoder_input_size, decoder_output_size, d_model, edge_index: 'edge_index',
                 device, edge_weight: 'edge_weights', nb_head, num_of_weeks, num_of_days, num_of_hours, points_per_hour,
                 num_for_predict=12, dropout=.0, aware_temporal_context=True, ScaledSAt=True, SE=True, TE=True,
                 kernel_size=3, smooth_layer_num=0, residual_connection=True, use_LayerNorm=True):
